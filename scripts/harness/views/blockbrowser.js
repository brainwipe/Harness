...
function($, jqueryui, Harness, BlockFactory) {
	...
	{
		for (i in this.Harness.BlockFactory.Factories)
		{
	...
	BlockBrowser.prototype.BlockListItem = function(blockBuilder)
	{
